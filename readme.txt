...
Really simple Constant Contant widget

== Description ==

A simple email subscribe widget that collects email addresses from visitors on your website and adds them to a contact list in your Constant Contact account:
